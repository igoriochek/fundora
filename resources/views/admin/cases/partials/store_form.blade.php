<form class="space-y-4" method="post" action="{{ route('cases.store') }}" enctype="multipart/form-data" files="true">
    @csrf
    @method('post')
        ...
        <div class="flex flex-col justify-center mt-2">
            <div class="flex items-center">
                <div class="flex items-center h-5">
                    <input id="is_visible" aria-describedby="is_visible" type="checkbox" name="is_visible" checked
